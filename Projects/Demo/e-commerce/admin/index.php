        ...
        <div id="content" class="content">
            ...
            <main class="main-content">
                <section id="dashboard" class="dashboard-section" style="display: block;">
                    <h1>Welcome, <?php echo $_GET['admin']; ?></h1>
                </section>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        // Use the previously fetched productDescription
                        echo '<td class="product-description">' . $row["description"] . '</td>';

                        // Display the product image using the image path
                        echo '<td class="product-image-cell"><img src="' . "../".$row["image_path"] . '" alt="Product Image" class="product-image"></td>';
                        echo '<td class="product-price">₹' . $row["price"] . '</td>';
                        echo '<td class="product-actions"><a href="update_product.php?id=' . $row["id"] . '">Edit</a> | <a href="remove_product.php?id=' . $row["id"] . '">Remove</a></td>';
                        echo '</tr>';
                    }
                    echo '</tbody>';
                    echo '</table>';
